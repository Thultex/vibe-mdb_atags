/*
========================================
A1 Check Versions v1.67 (sys 2.50)
========================================

Notes
- Expects collectAtags_lib v1.71 with alias-aware completeness tracking.
...
- Current libs:
  ...
  - collectAtags_lib v1.71 (sys 2.50)
...
var ATAG_EXPECTED_LIBS = [
  ...
  { id: "#1", title: "Collect Atags Lib", area: "core_lib", name: "collectAtags_lib", version: "1.71", getter: "getCollectAtagsLibVersion", path: "core_lib/collectAtags_lib.js" },
...
var ATAG_EXPECTED_OPTIONAL_LIBS = [
  { id: "A1", title: "Check Versions", area: "core", name: "checkVersions", version: "1.67", getter: "getCheckVersionsVersion", path: "core/_checkVersions.js", optional: true },
