...
- Current libs:
  ...
  - inputLinker_lib v0.50 (sys 2.30, optional)
...
var ATAG_EXPECTED_LIBS = [
  ...
  { name: "inputLinker_lib", version: "0.50", getter: "getInputLinkerLibVersion", path: "core_lib/inputLinker_lib.js", optional: true }
];
