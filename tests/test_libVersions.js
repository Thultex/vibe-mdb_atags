...
eval(read("addons\\2_syncing\\templateFieldTransfer.js"));
...
assertEquals("checkVersions-own-version", getCheckVersionsVersion().version, "1.77");
assertEquals("helpers-lib-own-version", getHelpersLibVersion().version, "2.14");
assertEquals("helpers-lib-sys-version", getHelpersLibVersion().sysVersion, "3.00");
assertEquals("collect-lib-own-version", getCollectAtagsLibVersion().version, "1.76");
assertEquals("export-lib-own-version", getExportAtagsLibVersion().version, "1.88");
assertEquals("tag-cleaner-own-version", getTagCleanerVersion().version, "1.60");
assertEquals("helpers-own-version", getHelpersVersion().version, "1.05");
assertEquals("helpers-mem-compat-version", getHelpersMemVersion().version, "1.05");
assertEquals("restore-atags-own-version", getRestoreAtagsVersion().version, "2.14");
...
assertEquals("export-lib-map-version", result.map.exportAtags_lib.version, "1.88");
assertEquals("collect-lib-map-version", result.map.collectAtags_lib.version, "1.76");
...
assertEquals("registered-optional-tag-cleaner", nonLib.map.tagCleaner.version, "1.60");
assertEquals("registered-optional-helpers", nonLib.map.helpers.version, "1.05");
...
assertTrue("text-result-has-export", textResult.indexOf("exportAtags_lib v1.88") !== -1);
assertTrue("text-result-has-collect", textResult.indexOf("collectAtags_lib v1.76") !== -1);
assertTrue("text-result-has-local-tag-cleaner", textResult.indexOf("LOCAL tagCleaner v1.60") !== -1);
...
assertTrue("hidden-local-summary-keeps-count", hiddenLocalText.indexOf("System v3.00 (ok, 3 rm, 17 local)") === 0);
assertTrue("hidden-local-lines-hidden", hiddenLocalText.indexOf("LOCAL tagCleaner v1.60") < 0);

var hiddenUppercaseLocalText = checkAtagLibVersions({ checkAccess: true, asText: true, SHOW_LOCAL_VERSIONS: false });
assertTrue("hidden-uppercase-local-lines-hidden", hiddenUppercaseLocalText.indexOf("LOCAL tagCleaner v1.60") < 0);
...
assertTrue("scoped-config-summary-after-config", scopedConfigText.indexOf("\n\nSystem v3.00 (ok, 1 rm, 1 local)") !== -1);
assertTrue("scoped-config-omits-remote", scopedConfigText.indexOf("collectAtags_lib v1.76") < 0);
assertTrue("scoped-config-omits-local", scopedConfigText.indexOf("LOCAL tagCleaner v1.60") < 0);
...
assertTrue("verbose-report-is-second-message", _logs[1].indexOf("System v3.00 (ok, 1 rm, 1 local)") === 0);
...
assertTrue("hidden-local-missing-summary-ok", hiddenLocalMissingText.indexOf("System v3.00 (ok, 3 rm, 16 local)") === 0);
...
assertTrue("visible-local-missing-summary", visibleLocalMissingText.indexOf("System v3.00 (miss, 1 missing)") === 0);
...
assertTrue("hidden-remote-missing-summary-ok", hiddenRemoteMissing.indexOf("System v3.00 (ok, 1 rm, 17 local)") === 0);
...
assertEquals("getter-only-old-mismatch", getterOnlyOldOptional.versionMismatch[0], "collectAtags_lib expected 1.76 got 1.39");
getCollectAtagsLibVersion = savedGetCollectAtagsLibVersion;
ATAG_LIB_VERSIONS = savedRegistry;

savedRegistry = ATAG_LIB_VERSIONS;
ATAG_LIB_VERSIONS = {};
registerAtagLibVersion("collectAtags_lib", "1.39", "3.00", "core_lib/collectAtags_lib.js");
var registryOnlyOldOptional = checkAtagLibVersions({ names: ["collectAtags_lib"], requireAll: false, asText: false });
assertEquals("registry-only-old-mismatch", registryOnlyOldOptional.versionMismatch[0], "collectAtags_lib expected 1.76 got 1.39");
ATAG_LIB_VERSIONS = {};
registerAtagLibVersion("collectAtags_lib", "1.99", "3.00", "core_lib/collectAtags_lib.js");
...
ATAG_LIB_VERSIONS = {};
registerAtagLibVersion("collectAtags_lib", "2.00", "3.00", "core_lib/collectAtags_lib.js");
var registryOnlyMajorOptional = checkAtagLibVersions({ names: ["collectAtags_lib"], requireAll: false, asText: false });
assertEquals("registry-only-major-mismatch", registryOnlyMajorOptional.versionMismatch[0], "collectAtags_lib expected major 1 got major 2 (1.76 vs 2.00)");
ATAG_LIB_VERSIONS = savedRegistry;
...
assertEquals("newer-wrong-sys-mismatch", newerWrongSys.versionMismatch[0], "collectAtags_lib expected sys 3.00 got sys 2.29");
getCollectAtagsLibVersion = savedGetCollectAtagsLibVersion;
ATAG_LIB_VERSIONS = savedRegistry;
...
assertTrue("hidden-remote-missmatch-summary-ok", hiddenRemoteMissmatchText.indexOf("System v3.00 (ok, 1 rm, 17 local)") === 0);
assertTrue("hidden-remote-missmatch-line-hidden", hiddenRemoteMissmatchText.indexOf("VERSION RM: collectAtags_lib expected 1.76 got 1.39") < 0);
getCollectAtagsLibVersion = savedGetCollectAtagsLibVersion;
ATAG_LIB_VERSIONS = savedRegistry;
...
assertTrue("optional-getter-sys-mismatch-summary", optionalGetterSysMismatchText.indexOf("System v3.00 (match, 1 local)") === 0);
assertTrue("optional-getter-sys-mismatch-visible", optionalGetterSysMismatchText.indexOf("VERSION LOCAL: tagCleaner expected sys 3.00 got sys 2.40") !== -1);
...
assertTrue("hidden-local-missmatch-summary-ok", hiddenLocalMissmatchText.indexOf("System v3.00 (ok, 3 rm, 17 local)") === 0);
assertTrue("hidden-local-missmatch-line-hidden", hiddenLocalMissmatchText.indexOf("VERSION LOCAL: tagCleaner expected 1.60 got 1.50") < 0);
getTagCleanerVersion = savedGetTagCleanerVersion;
ATAG_LIB_VERSIONS = savedRegistry;
...
var mixedVersionRemIndex = mixedOrderText.indexOf("VERSION RM: collectAtags_lib expected 1.76 got 1.39");
var mixedMissingRemIndex = mixedOrderText.indexOf("MISSING RM: #3 Helpers Lib (core_lib)");
var mixedVersionLocalIndex = mixedOrderText.indexOf("VERSION LOCAL: tagCleaner expected 1.60 got 1.50");
...
savedRegistry = ATAG_LIB_VERSIONS;
ATAG_LIB_VERSIONS = {};
registerAtagLibVersion("tagCleaner", "1.50", "3.00", "core/tagCleaner.js");
var optionalPluginMismatch = checkAtagLibVersions({ checkAccess: true, asText: false });
assertEquals("optional-plugin-mismatch", optionalPluginMismatch.versionMismatch[0], "tagCleaner expected 1.60 got 1.50");
...
assertTrue("optional-plugin-mismatch-text-summary", optionalPluginMismatchText.indexOf("System v3.00 (match, 1 local)") === 0);
assertTrue("optional-plugin-mismatch-text-visible", optionalPluginMismatchText.indexOf("VERSION LOCAL: tagCleaner expected 1.60 got 1.50") !== -1);
...
ATAG_LIB_VERSIONS = {};
registerAtagLibVersion("tagCleaner", "1.60", "3.00", "core/tagCleaner.js");
...
assertTrue("all-versions-text-has-helpers", allVersionsText.indexOf("helpers_lib v2.14") !== -1);
assertTrue("all-versions-text-has-collect", allVersionsText.indexOf("collectAtags_lib v1.76") !== -1);

checkAtagLibVersions({ checkAccess: true, verbose: true });
assertTrue("verbose-log-written", _logs.join("\n").indexOf("collectAtags_lib v1.76") !== -1);
