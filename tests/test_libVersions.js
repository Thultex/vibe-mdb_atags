...
assertEquals("linker-lib-own-version", getInputLinkerLibVersion().version, "0.32");
assertEquals("linker-lib-map-version", result.map.inputLinker_lib.version, "0.32");
...
assertTrue("text-result-has-linker", textResult.indexOf("inputLinker_lib v0.32") !== -1);
