...
assertEquals("linker-lib-own-version", getInputLinkerLibVersion().version, "0.56");
assertEquals("linker-lib-map-version", result.map.inputLinker_lib.version, "0.56");
...
assertTrue("text-result-has-linker", textResult.indexOf("inputLinker_lib v0.56") !== -1);
...
assertEquals("getter-only-old-optional-mismatch", getterOnlyOldOptional.versionMismatch[0], "inputLinker_lib expected 0.56 got 0.39");
...
assertEquals("registry-only-old-optional-mismatch", registryOnlyOldOptional.versionMismatch[0], "inputLinker_lib expected 0.56 got 0.39");
ATAG_LIB_VERSIONS = {};
...
assertTrue("all-versions-text-has-linker", allVersionsText.indexOf("inputLinker_lib v0.56") !== -1);

checkAtagLibVersions({ checkAccess: true, verbose: true });
assertTrue("verbose-log-written", _logs.join("\n").indexOf("inputLinker_lib v0.56") !== -1);
