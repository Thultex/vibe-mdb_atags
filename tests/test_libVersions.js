...
assertEquals("checkVersions-own-version", getCheckVersionsVersion().version, "1.76");
...
assertEquals("collect-lib-own-version", getCollectAtagsLibVersion().version, "1.75");
assertEquals("export-lib-own-version", getExportAtagsLibVersion().version, "1.87");
assertEquals("tag-cleaner-own-version", getTagCleanerVersion().version, "1.59");
...
assertEquals("export-lib-map-version", result.map.exportAtags_lib.version, "1.87");
assertEquals("collect-lib-map-version", result.map.collectAtags_lib.version, "1.75");
...
assertEquals("registered-optional-tag-cleaner", nonLib.map.tagCleaner.version, "1.59");
...
assertTrue("text-result-has-export", textResult.indexOf("exportAtags_lib v1.87") !== -1);
assertTrue("text-result-has-collect", textResult.indexOf("collectAtags_lib v1.75") !== -1);
assertTrue("text-result-has-local-tag-cleaner", textResult.indexOf("LOCAL tagCleaner v1.59") !== -1);
...
assertTrue("hidden-local-lines-hidden", hiddenLocalText.indexOf("LOCAL tagCleaner v1.59") < 0);

var hiddenUppercaseLocalText = checkAtagLibVersions({ checkAccess: true, asText: true, SHOW_LOCAL_VERSIONS: false });
assertTrue("hidden-uppercase-local-lines-hidden", hiddenUppercaseLocalText.indexOf("LOCAL tagCleaner v1.59") < 0);
...
assertTrue("scoped-config-omits-remote", scopedConfigText.indexOf("collectAtags_lib v1.75") < 0);
assertTrue("scoped-config-omits-local", scopedConfigText.indexOf("LOCAL tagCleaner v1.59") < 0);
...
assertEquals("getter-only-old-mismatch", getterOnlyOldOptional.versionMismatch[0], "collectAtags_lib expected 1.75 got 1.39");
...
assertEquals("registry-only-old-mismatch", registryOnlyOldOptional.versionMismatch[0], "collectAtags_lib expected 1.75 got 1.39");
ATAG_LIB_VERSIONS = {};
...
assertEquals("registry-only-major-mismatch", registryOnlyMajorOptional.versionMismatch[0], "collectAtags_lib expected major 1 got major 2 (1.75 vs 2.00)");
ATAG_LIB_VERSIONS = savedRegistry;
...
assertTrue("hidden-remote-missmatch-line-hidden", hiddenRemoteMissmatchText.indexOf("VERSION RM: collectAtags_lib expected 1.75 got 1.39") < 0);
getCollectAtagsLibVersion = savedGetCollectAtagsLibVersion;
ATAG_LIB_VERSIONS = savedRegistry;
...
assertTrue("hidden-local-missmatch-line-hidden", hiddenLocalMissmatchText.indexOf("VERSION LOCAL: tagCleaner expected 1.59 got 1.50") < 0);
getTagCleanerVersion = savedGetTagCleanerVersion;
ATAG_LIB_VERSIONS = savedRegistry;
...
var mixedVersionRemIndex = mixedOrderText.indexOf("VERSION RM: collectAtags_lib expected 1.75 got 1.39");
var mixedMissingRemIndex = mixedOrderText.indexOf("MISSING RM: #3 Helpers Lib (core_lib)");
var mixedVersionLocalIndex = mixedOrderText.indexOf("VERSION LOCAL: tagCleaner expected 1.59 got 1.50");
...
assertEquals("optional-plugin-mismatch", optionalPluginMismatch.versionMismatch[0], "tagCleaner expected 1.59 got 1.50");
...
assertTrue("optional-plugin-mismatch-text-visible", optionalPluginMismatchText.indexOf("VERSION LOCAL: tagCleaner expected 1.59 got 1.50") !== -1);
...
ATAG_LIB_VERSIONS = {};
registerAtagLibVersion("tagCleaner", "1.59", "3.00", "core/tagCleaner.js");
...
assertTrue("all-versions-text-has-collect", allVersionsText.indexOf("collectAtags_lib v1.75") !== -1);

checkAtagLibVersions({ checkAccess: true, verbose: true });
assertTrue("verbose-log-written", _logs.join("\n").indexOf("collectAtags_lib v1.75") !== -1);
