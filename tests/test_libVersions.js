...
assertEquals("checkVersions-own-version", getCheckVersionsVersion().version, "1.62");
...
assertEquals("template-transfer-own-version", getTemplateFieldTransferVersion().version, "1.02");
assertEquals("template-transfer-registered-version", ATAG_LIB_VERSIONS.templateFieldTransfer.version, "1.02");
...
assertEquals("generic-getter-template-transfer-version", templateTransferGetterResult.map.templateFieldTransfer.version, "1.02");
...
assertTrue("text-result-has-local-template-transfer", textResult.indexOf("LOCAL templateFieldTransfer v1.02") !== -1);
