...
assertEquals(
  "tag-comment-content-stays-literal",
  makeTagCleanerText("ED2(p1)"),
  "ED\u00B2(p1)"
);

assertEquals(
  "tag-comment-content-stays-literal-with-alias",
  makeTagCleanerTextWithOptions("ED2(p1)", {
    aliasText: "@@EmoDys (ED):",
    cleanerTagText: "long"
  }),
  "EmoDys\u00B2(p1)"
...
assertEquals(
  "alias-display-repeated-minus-is-not-part-of-short-name",
  makeTagCleanerTextWithOptions("test2 tst3", {
    aliasText: "@@test(tst--)"
  }),
  "tst\u00B2 tst\u00B3"
);
