...
assertItem("colon-open-slot-number-value", "Kiefer:_1", "Kiefer", "+1", 1, null, null);
assertItem("colon-open-slot-negative-decimal-value", "Kiefer:_-1,4", "Kiefer", "-1,4", -1.4, null, null);
assertItem("colon-open-slot-positive-decimal-value", "Kiefer:_+1,4", "Kiefer", "+1,4", 1.4, null, null);
assertItem("colon-open-slot-dot-decimal-value", "Kiefer:_1.4", "Kiefer", "1.4", 1.4, null, null);
assertItem("colon-open-slot-cumulative-value", "Kiefer:_++", "Kiefer", "++", 2, null, null);
assertItem("colon-spaced-open-slot-negative-decimal-value", "Kiefer: _-1,4", "Kiefer", "-1,4", -1.4, null, null);
assertItem("colon-explicit-open-slot-negative-decimal-value", "Kiefer::_-1,4", "Kiefer", "-1,4", -1.4, null, null);
assertItem("colon-spaced-slot-string-value", "Laufen: _2 km_", "Laufen", "2 km", "2 km", null, null);
