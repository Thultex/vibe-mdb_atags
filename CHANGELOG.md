...
- Fix: `Input Linker` v0.58 blockiert bei geloeschten vorhandenen DayLinks keine Neuzuordnung mehr; Link-only darf wieder einen neuen Ziel-Day erstellen/verlinken.
...
- *Versionen: collectAtags_lib v1.59, Input Linker v0.58, libVersions v1.16, Time Marker v1.32, Global Field Sync v1.03, Sequence Counter v1.05.*
