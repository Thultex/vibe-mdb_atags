...
- Fix: `Input Linker` v0.86 nimmt im Vergleich zur letzten stabilen DustingDay-Phase auch die DayId-Auswertung aus `refreshTargetFromInputEntries()` heraus; Refresh/Rebuild wählt Inputs wieder nur über die Relation `DayLinks`. v0.85 entfernte bereits die kritischen Restore-/EnsureActive- und DayId-Schreibfunktionen.
...
- *Versionen: sys 2.40, collectAtags_lib v1.61, Input Linker v0.86, libVersions v1.28, Time Marker v1.37, Tag Pair Parser v1.01, restoreAtags v2.08, Global Field Sync v1.03, Sync Last From Latest v1.05, Sequence Counter v1.05.*
