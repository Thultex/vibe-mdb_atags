...
- Feature: `Input Linker` v0.63 kann mit `receiveAfterLink: true` nach frisch gesetztem Script-Link den Day-Receive direkt ausführen; v0.62 exportiert `recieveInputEntryFromSource()` explizit global.
...
- *Versionen: collectAtags_lib v1.59, Input Linker v0.63, libVersions v1.16, Time Marker v1.32, Global Field Sync v1.03, Sequence Counter v1.05.*
