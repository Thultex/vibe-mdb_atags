...
- Debug: `Input Linker` v0.70 akzeptiert Receive-Flags als true/"true"/1 und zeigt sie im Trace; v0.69 ergänzt `debugReceive: true` fuer Link-/Update-/Receive-Traces.
...
- *Versionen: collectAtags_lib v1.59, Input Linker v0.70, libVersions v1.16, Time Marker v1.32, Global Field Sync v1.03, Sequence Counter v1.05.*
