...
- Feature: `Input Linker` v0.64 kann mit `receiveExistingLink: true` bestehende Links bewusst fuer Update-Tests verarbeiten; v0.63 kann nach frisch gesetztem Script-Link den Day-Receive direkt ausführen.
...
- *Versionen: collectAtags_lib v1.59, Input Linker v0.64, libVersions v1.16, Time Marker v1.32, Global Field Sync v1.03, Sequence Counter v1.05.*
