...
| --- | ---: | ---: | --- |
| #1 collectAtags_lib | 1.55 | 2.30 | `core_lib/collectAtags_lib.js` |
| #2 exportAtags_lib | 1.82 | 2.30 | `core_lib/exportAtags_lib.js` |
...
| Name | Version | Sys | Pfad |
| --- | ---: | ---: | --- |
| A1 libVersions | 1.08 | 2.30 | `core/_checkLibs.js` |
