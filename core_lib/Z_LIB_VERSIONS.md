...
| Name | Version | Sys | Pfad |
| --- | ---: | ---: | --- |
| A1 Check Versions | 1.59 | 2.50 | `core/_checkVersions.js` |
...
| B11 templateFieldTransfer | 1.00 | 2.50 | `addons/2_syncing/templateFieldTransfer.js` | Gefuellte Templates verschieben und Vollstaendigkeit tracken |
